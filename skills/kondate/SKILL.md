...
> **解釈注意（厳守）:** 「〇食分作りたい」と言われたら、**まず「1品を〇人前作るのか、〇食分の献立を計画するのか」を確認してから進む。** 確認なしで解釈して進むのは禁止。
> 「〇食分作り置き」の「〇食分」= 1品あたりのサービング数。品数ではない。「何食分の何品か」が不明な場合も同様に確認する。
